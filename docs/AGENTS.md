# Computer Science for Secondary Schools: Student’s Book Form Two — ADT Bundle Reference
...
**Computer Science for Secondary Schools: Student’s Book Form Two** — This is an English-language Computer Science textbook for Form Two secondary students in Tanzania, published by the Tanzania Institute of Education and aligned with the country’s Ordinary Level syllabus. It covers Internet concepts and services, cybersecurity, introductory programming, and practical coding in both C and Python, with a clear lower-secondary reading level. The book uses a competency-based, activity-oriented approach, combining explanations with scenarios, exercises, projects, portfolios, and hands-on tasks to build digital literacy, responsible Internet use, and foundational programming skills.
...
├── computer-science-f2-textbook.db                    # SQLite database (pipeline state)
├── computer-science-f2-textbook.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "A student viewed from behind works at three computer monitors beneath a large communications satellite over a futuristic city skyline at sunset.",
  "gl001": "#define",
  "gl001_def": "A preprocessor command used to create a named constant or macro.",
  "qz001_que": "What is the Internet?",
  "qz001_o0": "1) A worldwide system of connected computer networks",
  "qz001_o0_exp": "✅ Correct! The text explains that the Internet is a global network of connected computer networks and devices."
}
```
...
```json
{
  "#define": {
    "word": "#define",
    "definition": "A preprocessor command used to create a named constant or macro.",
    "variations": ["#define","define","macro","macros"],
    "emoji": "🏷️⚡"
  }
}
```
...
```json
{
  "title": "Computer Science for Secondary Schools: Student’s Book Form Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is the Internet?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Correct! The text explains that the Internet is a global network of connected computer networks and devices." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) A worldwide system of connected computer networks</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `computer-science-f2-textbook.pdf` |
| Pipeline database | `computer-science-f2-textbook.db` (SQLite) |
